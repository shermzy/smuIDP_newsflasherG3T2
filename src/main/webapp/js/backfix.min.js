...
var bajb_backdetect = {Version: '1.0.0', Description: 'Back Button Detection', Browser: {IE: !!(window.attachEvent && !window.opera), Safari: navigator.userAgent.indexOf('Apple') > -1, Opera: !!window.opera}, FrameLoaded: 0, FrameTry: 0, FrameTimeout: null, OnBack: function() {
        ...
        window.location.hash = '#newsFlasher';
       ...
       history.back();
        ...
        if (bajb_backdetect.FrameLoaded == 5) {
        ...
        if (bajb_backdetect.FrameLoaded == 1 && checkVar != "HistoryLoad") {
            ...
            if (bajb_backdetect.FrameTry > 10 && checkVar != "HistoryLoad") {
        ...
        if (bajb_backdetect.SafariHash == 'false') {
            if (window.location.hash == '#newsFlasher') {
            ...
            if (window.location.hash == '') {
                ...
                setTimeout("bajb_backdetect.Safari();", 200);
