...
!function(a, b, c) {
    ...
    !function(a) {
        ...
        a.widget("mobile.loader", {options: {theme: "a", textVisible: !1, html: "", text: ""}, defaultHtml: "<div class='" + b + "'><span class='ui-icon-loading'></span><h1></h1></div>", fakeFixLoader: function() {
